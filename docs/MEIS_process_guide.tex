...
\hypertarget{software-requirements-for-project}{%
\chapter{Software Requirements for Project}\label{software-requirements-for-project}}

To recreate California's study or perform studies in additional areas, the software used to obtain and process that data is needed. Fortunately all software is free and available online.(Where possible, make sure to use the most recent and fully updated versions of the software).
