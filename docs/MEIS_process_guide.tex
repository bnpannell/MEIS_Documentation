...
\emph{Place holder for section on how to enter the output files into implan and what IMPLAN analysis was run so that our study can be repeated.}

\emph{Should not go into too much detail, as full instructions on how IMPLAN works is outside of the scope of this process guide.}
