...
## Output Folder
This folder is located within the main folder and holds all the final output files needed by IMPLAN to complete this project. New output files will get created and placed into this folder as scripts are run. - **placeholder.txt:** This file prevents Github from deleting the output folder, as it is empty by default.  
