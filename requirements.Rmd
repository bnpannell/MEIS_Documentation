...
## Download Necessary R Libraries
...
- **dplyr:** Used for manipulating dataframes. \citep{dplyr1}
- **httr:** Used for working with URLs and HTTP. \citep{httr2}
- **jsonlite:** Used for interacting with JSON data and web APIs. \citep{json3}
- **openxlsx:** Used for reading, writing and editing xlsx files. \citep{openxlsx4}
- **readxl:** Used for legacy excel .xls files. \citep{readxl5}
- **tidyverse:** A collection of R packages optimized for data science. \citep{tidyverse6} 
